...
> **Важное примечание:** Стек технологий для данного ТЗ может показаться избыточным. Однако целью проекта было не перенасыщение системы лишними инструментами, а демонстрация владения стеком для обеспечения **максимальной надежности и прозрачности** системы. Особый акцент сделан на отработке культуры ведения технической документации и подготовке проекта к эксплуатации в production-условиях.
