...
<p>**Что это дает?** Теперь можно видеть графики нагрузки из Prometheus и текстовые логи из Loki в одной экосистеме. Это позволяет проводить корреляцию:  видеть, какие именно ошибки вызвали всплеск потребления CPU.</p> 
