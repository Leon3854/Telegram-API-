...
Фиксируем правила (Manual Ack и Redis), которые никто не должен нарушать.<br/>
Созданы файлов — .ai-instructions и .cursorrules — это не дубляж, это кросс-платформенная совместимость для AI-инструментов.</br>
.cursorrules — делает IDE (Cursor) «умной» в контексте этого проекта. Она не будет предлагать «галлюцинации», а будет следовать жестким правилам по Redis и RabbitMQ.<br/>
.ai-instructions — универсальный стандарт. Любой другой LLM (Claude, GPT-4, Windsurf), открыв проект, сразу поймет что делать.
